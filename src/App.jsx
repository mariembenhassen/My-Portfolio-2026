...
const PersonalBranding = lazy(() =>
  import("./components/sections/PersonalBranding")
);
...
const FloatingNavigation = lazy(() =>
  import("./components/layout/FloatingNavigation")
);
const CertificationsSection = lazy(() =>
  import("./components/sections/Certifications/CertificationsSection")
);
...
function AppContent() {
  ...
  return (
    <div
      className={`overflow-x-hidden antialiased transition-colors duration-500 ${
    ...
    >
      ...
      <main
        id="main-content"
        className="container mx-auto px-4 md:px-8 pb-32 md:pb-24"
        tabIndex="-1"
      >
